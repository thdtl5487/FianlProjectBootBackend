...
import com.springboot.react.cboard.reply.controller.ReplyRepository;
...
//   }
   ...
   public void ReplyListTest() {
		   ...
		   System.out.println("이거 안돼?" + repl.findByBNum(1L));
   ...
   @Test
   public void ReplyDelete(Long rnum) {
	   rnum = 8L;
	   repl.deleteById(rnum);
   }
